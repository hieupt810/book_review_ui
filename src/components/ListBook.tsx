...
const fetcher = (..._args: any[]) => fetch(..._args).then((res) => res.json());
            ...
            <div className="flex gap-x-4 items-center my-2 p-4 rounded-lg hover:bg-slate-200 shadow-md">
              ...
              <div className="flex flex-col justify-center h-full gap-y-8">
                <div className="flex flex-col gap-y-2">
                  <span className="text-xl uppercase leading-6">
                    {item.title}
                  </span>
                ...
                <div>
                  <span className="bg-[#C9C39F] text-xs px-4 py-2 rounded-full">
                    {item.category}
                  </span>
                </div>
              </div>
